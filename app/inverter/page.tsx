      ...
      <section className="border-b border-white/5" style={{ backgroundColor: "#161616" }}>
        <div className="mx-auto  max-w-full px-4 py-12 sm:px-8 lg:px-20">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-relaxed" style={{ color: "#888888" }}>
              Reparo em nível de componente de placas controladoras de ar-condicionado inverter,
              inversores solares e fontes chaveadas. Laboratório equipado com osciloscópio,
              estação de solda e fonte de bancada.
            </p>

            <div className="mt-6 flex flex-wrap justify-center gap-4">
              <div className="flex items-center gap-2 rounded-full border border-white/10 px-4 py-2 text-xs" style={{ color: "#8B5CF6" }}>
