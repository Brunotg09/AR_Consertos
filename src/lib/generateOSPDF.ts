  ...
  autoTable(doc, {
    ...
    didParseCell: (data) => {
      if (data.section === "body" && data.column.index === 1) {
        ...
        if (tipo === "Inverter") {
          data.cell.styles.fillColor = `rgba(${purple[0]},${purple[1]},${purple[2]},0.12)`;
          data.cell.styles.textColor = `rgb(${purple[0]},${purple[1]},${purple[2]})`;
        } else if (tipo === "Convencional") {
          data.cell.styles.fillColor = `rgba(${red[0]},${red[1]},${red[2]},0.12)`;
          data.cell.styles.textColor = `rgb(${red[0]},${red[1]},${red[2]})`;
        } else {
          data.cell.styles.fillColor = `rgba(${gold[0]},${gold[1]},${gold[2]},0.08)`;
          data.cell.styles.textColor = `rgb(${gold[0]},${gold[1]},${gold[2]})`;
        }
      }
    },
