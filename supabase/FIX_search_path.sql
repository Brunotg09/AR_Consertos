-- CORRECAO TOTAL: Todas as funcoes com search_path correto

-- link_cliente_on_signup (trigger - SECURITY INVOKER)
...
-- estornar_estoque_cancelamento (trigger - SECURITY INVOKER)
...
-- update_session_timestamp (trigger - SECURITY INVOKER)
...
-- managed_decrement_stock (SECURITY INVOKER)
...
-- managed_increment_stock (SECURITY INVOKER)
...
-- is_admin (SECURITY DEFINER - manter search_path vazio por seguranca)
...
-- insert_profile (SECURITY DEFINER - manter search_path vazio)
...
-- check_session_timeout (SECURITY DEFINER)
...
-- get_user_orders_with_items (SECURITY DEFINER)
...
-- get_all_orders_with_items (SECURITY DEFINER)
...
-- Stock functions (SECURITY DEFINER)
